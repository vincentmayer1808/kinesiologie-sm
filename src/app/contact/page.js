...
const page = () => {
  ...
  return (
    <div className='text-center'>
      <h2 className='text-gris font-semibold text-2xl'>Contacte-Moi</h2>
      ...
      <p>*Service offert en ligne ou en présentiel dans la région de Mont-Tremblant et alentour.</p>
